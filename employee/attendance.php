...
<title>Le Mie Presenze - Mini HR</title><link rel="stylesheet" href="/style.css"></head>
<body><div class="app-layout">
<?php include ROOT.'/partials/sidebar_emp.php'; ?>
<header class="topbar"><span class="topbar-title">Le Mie Presenze</span>
...
<main class="main-content"><div class="page-header"><h1>Le Mie Presenze</h1><p>Implementazione: Fase successiva</p></div>

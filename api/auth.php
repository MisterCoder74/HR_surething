...
if ($method === 'POST' && $action === 'login') {
    ...
    if (!$user || !password_verify($password, $user['password_hash'])) json_response(['error'=>'Credenziali non valide'], 401);
...
if ($action==='logout') { session_unset(); session_destroy(); json_response(['success'=>true,'redirect'=>'/login.php']); }
